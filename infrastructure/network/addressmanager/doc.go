/*
Package addressmanager implements concurrency safe katkoin address manager.

# Address Manager Overview

In order maintain the peer-to-peer katkoin network, there needs to be a source
of addresses to connect to as nodes come and go. The katkoin protocol provides
