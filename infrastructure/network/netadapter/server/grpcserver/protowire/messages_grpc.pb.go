...
type P2P_MessageStreamClient interface {
	Send(*KatdMessage) error
	Recv() (*KatdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *KatdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*KatdMessage, error) {
	m := new(KatdMessage)
...
func (x *p2PMessageStreamServer) Send(m *KatdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*KatdMessage, error) {
	m := new(KatdMessage)
...
func (x *rPCMessageStreamClient) Send(m *KatdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*KatdMessage, error) {
	m := new(KatdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *KatdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*KatdMessage, error) {
	m := new(KatdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
