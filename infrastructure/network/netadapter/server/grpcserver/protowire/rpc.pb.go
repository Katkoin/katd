...
type GetBlockTemplateRequestMessage struct {
	...
	// Which katkoin address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether katd thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when katd is not synced.
	// That is because when katd isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this katd initiated the connection
	...
	// The timestamp of when this peer connected to this katd
