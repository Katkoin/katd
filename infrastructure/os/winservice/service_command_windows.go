...
// installService attempts to install the katd service. Typically this should
...
// removeService attempts to uninstall the katd service. Typically this should
...
// startService attempts to Start the katd service.
