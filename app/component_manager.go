...
// Start launches all the katd services.
...
// Stop gracefully shuts down all the katd services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("katd is already in the process of shutting down")
		return
	}

	log.Warnf("katd shutting down")
