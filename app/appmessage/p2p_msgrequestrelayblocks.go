...
// MsgRequestRelayBlocks implements the Message interface and represents a katkoin
...
// NewMsgRequestRelayBlocks returns a new katkoin RequestRelayBlocks message that conforms to
