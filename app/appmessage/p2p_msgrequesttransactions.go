...
// MsgRequestTransactions implements the Message interface and represents a katkoin
...
// NewMsgRequestTransactions returns a new katkoin RequestTransactions message that conforms to
