...
// MsgDoneHeaders implements the Message interface and represents a katkoin
...
// NewMsgDoneHeaders returns a new katkoin DoneIBDBlocks message that conforms to the
// Message interface.
