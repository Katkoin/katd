...
// RPCTransaction is a katd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a katd transaction input representation
...
// RPCScriptPublicKey is a katd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a katd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a katd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a katd utxo entry representation meant to be used
// over RPC
