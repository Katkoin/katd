...
var DefaultUserAgent = fmt.Sprintf("/katd:%s/", version.Version())

// MsgVersion implements the Message interface and represents a katkoin version
...
// NewMsgVersion returns a new katkoin version message that conforms to the
