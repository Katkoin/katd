...
// MsgRequestAnticone implements the Message interface and represents a katkoin
...
// NewMsgRequestAnticone returns a new katkoin RequestPastDiff message that conforms to the
