...
// katkoin Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a katkoin
// Addresses message.
...
// NewMsgAddresses returns a new katkoin Addresses message that conforms to the
