...
// MsgRequestNextHeaders implements the Message interface and represents a katkoin
...
// NewMsgRequestNextHeaders returns a new katkoin RequestNextHeaders message that conforms to the
// Message interface.
