...
// MsgRequestAddresses implements the Message interface and represents a katkoin
...
// NewMsgRequestAddresses returns a new katkoin RequestAddresses message that conforms to the
