...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a katkoin
...
// NewMsgDoneBlocksWithTrustedData returns a new katkoin DoneBlocksWithTrustedData message that conforms to the
// Message interface.
