...
// MsgRequestHeaders implements the Message interface and represents a katkoin
...
// NewMsgRequstHeaders returns a new katkoin RequestHeaders message that conforms to the
