...
// MsgTransactionNotFound defines a katkoin TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new katkoin transactionsnotfound message that conforms to the
