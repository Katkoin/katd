...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := katd.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = katd.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = katd.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
