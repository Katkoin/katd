...
// other than the base unit of a katkoin. The value of the AmountUnit
// is the exponent component of the decadic multiple to convert from
// an amount in katkoin to an amount counted in units.
type AmountUnit int

// These constants define various units used when describing a katkoin
// monetary amount.
const (
...
// Amount represents the base katkoin monetary unit (colloquially referred
// to as a `Sompi'). A single Amount is equal to 1e-8 of a katkoin.
type Amount uint64
...
// some value in katkoin. NewAmount errors if f is NaN or +-Infinity, but
// does not check that the amount is within the total amount of katkoin
...
// floating point value representing an amount of katkoin.
...
// Format formats a monetary amount counted in katkoin base units as a
...
// useful for services that build on top of katkoin (for example, calculating
