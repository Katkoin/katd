...
import (
	...
	"github.com/Katkoin/katd/domain/consensus/datastructures/daawindowstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/mergedepthrootstore"
	"github.com/Katkoin/katd/domain/consensus/model"
	"github.com/Katkoin/katd/domain/consensus/processes/blockparentbuilder"
	parentssanager "github.com/Katkoin/katd/domain/consensus/processes/parentsmanager"
	"github.com/Katkoin/katd/domain/consensus/processes/pruningproofmanager"
	...
	consensusdatabase "github.com/Katkoin/katd/domain/consensus/database"
	"github.com/Katkoin/katd/domain/consensus/datastructures/acceptancedatastore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/blockheaderstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/blockrelationstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/blockstatusstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/blockstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/consensusstatestore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/daablocksstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/finalitystore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/ghostdagdatastore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/headersselectedchainstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/headersselectedtipstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/multisetstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/pruningstore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/reachabilitydatastore"
	"github.com/Katkoin/katd/domain/consensus/datastructures/utxodiffstore"
	"github.com/Katkoin/katd/domain/consensus/model/externalapi"
	"github.com/Katkoin/katd/domain/consensus/model/testapi"
	"github.com/Katkoin/katd/domain/consensus/processes/blockbuilder"
	"github.com/Katkoin/katd/domain/consensus/processes/blockprocessor"
	"github.com/Katkoin/katd/domain/consensus/processes/blockvalidator"
	"github.com/Katkoin/katd/domain/consensus/processes/coinbasemanager"
	"github.com/Katkoin/katd/domain/consensus/processes/consensusstatemanager"
	"github.com/Katkoin/katd/domain/consensus/processes/dagtopologymanager"
	"github.com/Katkoin/katd/domain/consensus/processes/dagtraversalmanager"
	"github.com/Katkoin/katd/domain/consensus/processes/difficultymanager"
	"github.com/Katkoin/katd/domain/consensus/processes/finalitymanager"
	"github.com/Katkoin/katd/domain/consensus/processes/ghostdagmanager"
	"github.com/Katkoin/katd/domain/consensus/processes/headersselectedtipmanager"
	"github.com/Katkoin/katd/domain/consensus/processes/mergedepthmanager"
	"github.com/Katkoin/katd/domain/consensus/processes/pastmediantimemanager"
	"github.com/Katkoin/katd/domain/consensus/processes/pruningmanager"
	"github.com/Katkoin/katd/domain/consensus/processes/reachabilitymanager"
	"github.com/Katkoin/katd/domain/consensus/processes/syncmanager"
	"github.com/Katkoin/katd/domain/consensus/processes/transactionvalidator"
