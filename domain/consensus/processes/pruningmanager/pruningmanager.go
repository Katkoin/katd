...
import (
	...
	"github.com/katkoin/katdd/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that katd doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
