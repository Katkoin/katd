...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One katkoin is a quantity of sompi as defined by the
	// sompiPerKatkoin constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for katkoin, but perhaps possible if an alt increases
