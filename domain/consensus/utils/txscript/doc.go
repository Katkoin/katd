/*
Package txscript implements the katkoin transaction script language.

This package provides data structures and functions to parse and execute
katkoin transaction scripts.

# Script Overview

Katkoin transaction scripts are written in a stack-base, FORTH-like language.

The katkoin script language consists of a number of opcodes which fall into
...
Typical katkoin scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend katkoin.
