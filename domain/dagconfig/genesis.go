...
var genesisTxPayload = []byte{
	...
	0x01,                                           // Varint
	0x00,                                           // OP-FALSE
	0x6D, 0x65, 0x6F, 0x77, 0x20, 0x6D, 0x69, 0x61, // meow miaow miaou мяу meu mjau miau miau miamha mjá miao nau ngeong miauw mjau miao mnau mjau miyav ngoao
	0x6F, 0x77, 0x20, 0x6D, 0x69, 0x61, 0x6F, 0x75,
	0x20, 0xD0, 0xBC, 0xD1, 0x8F, 0xD1, 0x83, 0x20,
	0x6D, 0x65, 0x75, 0x20, 0x6D, 0x6A, 0x61, 0x75,
	0x20, 0x6D, 0x69, 0x61, 0x75, 0x20, 0x6D, 0x69,
	0x61, 0x75, 0x20, 0x6D, 0x69, 0x61, 0x6D, 0x68,
	0x61, 0x20, 0x6D, 0x6A, 0xC3, 0xA1, 0x20, 0x6D,
	0x69, 0x61, 0x6F, 0x20, 0x6E, 0x61, 0x75, 0x20,
	0x6E, 0x67, 0x65, 0x6F, 0x6E, 0x67, 0x20, 0x6D,
	0x69, 0x61, 0x75, 0x77, 0x20, 0x6D, 0x6A, 0x61,
	0x75, 0x20, 0x6D, 0x69, 0x61, 0x6F, 0x20, 0x6D,
	0x6E, 0x61, 0x75, 0x20, 0x6D, 0x6A, 0x61, 0x75,
	0x20, 0x6D, 0x69, 0x79, 0x61, 0x76, 0x20, 0x6E,
	0x67, 0x6F, 0x61, 0x6F,
}
...
var genesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0xA2, 0x75, 0x1E, 0x73, 0xF2, 0xB8, 0x2, 0xD9,
	0xC3, 0x90, 0x55, 0x35, 0xAE, 0x91, 0xE1, 0xC,
	0x34, 0x27, 0x49, 0xCE, 0x1E, 0x8F, 0x21, 0x76,
	0x54, 0x2, 0xCB, 0x13, 0xA7, 0xF8, 0x3C, 0x14,
})
...
var devnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x64, 0x65, 0x76, 0x6e, 0x65, 0x74, // katkoin-devnet
}
...
var simnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74, // katkoin-simnet
}
...
var testnetGenesisTxPayload = []byte{
	...
	0x01,                                                                         // Varint
	0x00,                                                                         // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74, // katkoin-testnet
}
