...
// Params defines a katkoin network by its parameters. These parameters may be
// used by katkoin applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/katkoin/research/issues/3
...
var MainnetParams = Params{
	...
	DefaultPort: "11121",
	DNSSeeds: []string{
		// This DNS seeder not run yet
		"mainnet-dnsseed.kat.coin",
	},
...
// SimnetParams defines the network parameters for the simulation test katkoin
...
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32Prefixkatdev,
...
// ErrDuplicateNet describes an error where the parameters for a katkoin
