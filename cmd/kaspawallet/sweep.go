...
import (
	...
	"github.com/Katkoin/katd/cmd/katwallet/daemon/client"
	"github.com/katkoin/katdd/cmd/katwallet/daemon/pb"
	"github.com/katkoin/katdd/cmd/katwallet/libkatwallet"
	"github.com/katkoin/katdd/cmd/katwallet/libkatwallet/serialization"
	"github.com/katkoin/katdd/cmd/katwallet/utils"
...
func sweep(conf *sweepConfig) error {
	...
	publicKeybytes, err := libkatwallet.PublicKeyFromPrivateKey(privateKeyBytes)
	if err != nil {
		return err
	}
	...
	UTXOs, err := libkatwallet.katwalletdUTXOsTolibkatwalletUTXOs(getExternalSpendableUTXOsResponse.Entries)
	if err != nil {
		return err
	}
